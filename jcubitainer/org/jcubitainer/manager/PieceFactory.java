...
public class PieceFactory {
    ...
    public static final boolean[][] format = { { true, false}, { true, true}};
    ...
    public static final boolean[][] format4 = { { true}, { true}, { true},
            { true}};
    ...
    public static final boolean[][] format8 = { { false, true}, { true, false}};
    ...
    public DisplayPiece getDisplayPiece(int level) {
        int max_matiere = Theme.getCurrent().getMAX_MATIERE();
        int max = 8 + level;
