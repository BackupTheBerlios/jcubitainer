...
public class NetworkDisplayTable extends JPanel {
	...
	protected static NetworkDisplayTable parties =
		new NetworkDisplayTable("Parties", 150, 200, true);

	protected static NetworkDisplayTable joueurs =
		new NetworkDisplayTable("Joueurs", 150, 200, false);

	public NetworkDisplayTable(
		String ptitle,
		int largeur,
		int hauteur,
		boolean actif) {
			...
			rowSM.addListSelectionListener(new ListSelectionListener() {
				public void valueChanged(ListSelectionEvent e) {
					...
					if (lsm.isSelectionEmpty()) {
						...
						setGroup_selectionne(
							(GroupTable) model.getValueAt(selectedRow, 0));
